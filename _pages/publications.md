...
===
1. **Zhao, L**., Bai, Y*., 2022. Hierarchical path planning framework for unmanned surface vehicles based on adaptive enhanced non-dominated sorting genetic algorithm (AENSGA-II).
...
7.   Wang, F., **Zhao, L**., Bai, Y*., 2022. Path planning for unmanned surface vehicles based on modified artificial fish swarm algorithm with local optimizer. Mathematical Problem in Engineering. [https://doi.org/10.1155/1970/1283374](https://doi.org/10.1155/1970/1283374)
