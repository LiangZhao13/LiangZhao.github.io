...
2. **Zhao, L**., Bai, Y*., Paik, JK., 2023. Global path planning and waypoint following for heterogeneous unmanned surface vehicles assisting inland water monitoring. **Journal of Ocean Engineering and Science**. (accepted, in press)
